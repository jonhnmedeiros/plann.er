...
export function CreateTripPage() {
    ...
    const [isConfirmTripModalOpen, setIsConfirmConfirmModalOpen] = useState(false)
    ...
    async function createTrip(event: FormEvent<HTMLFormElement>) {
        ...
        if (!destination || !ownerName || !ownerEmail || !eventStartAndEndDates?.to || !eventStartAndEndDates?.from || emailsToInvite.length === 0) {
            return
        }
