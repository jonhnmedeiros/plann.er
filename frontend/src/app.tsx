          ...
          <div className='w-[650px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            <div className='space-y-2'>
              ...
              <p className='text-sm text-zinc-400'>
                Os convidados irão receber e-mails para continuar a participação na viagem.
              </p>
            </div>
              ...
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                    ...
                    <button type='button'>
                      <X className='size-5 text-zinc-400' onClick={() => removeEmailFromInvites(email)} />
                    </button>
                  </div>
                )
              })}
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
              ...
              <button type='submit' className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400'>
                Convidar<Plus className='size-5' /></button>
            </form>
          </div>
        </div>
